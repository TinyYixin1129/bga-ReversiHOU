...
namespace Bga\Games\ReversiHOU;
...
//       }
    ...
    protected function setupNewGame($players, $options = [])
    {
        ...
        //     SELECT player_id, player_color
        //     FROM player
        // ");
        // foreach ($players as $player_id => $player) {
        //     if ($player['player_color'] === '000000') {
        //         $blackplayer_id = $player_id;
        //     } else if ($player['player_color'] === 'ffffff') {
    ...
    */
    ...
    public function getTurnedOverDiscs( $x, $y, $player, $board )
    {
    ...
    function actPlayDisc( int $x, int $y ){
        ...
        if( count( $turnedOverDiscs ) > 0 )
        {
            ...
            $sql .= "('$x','$y') ) ";  //Don't forget the new disc
